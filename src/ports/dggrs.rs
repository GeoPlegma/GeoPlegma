...
pub trait DggrsPort: Send + Sync {
    ...
    fn zone_from_point(&self, depth: u8, point: Point, densify: bool) -> Zones; // NOTE:Consider accepting a vector of Points.
    ...
    fn zone_from_id(&self, zone_id: String, densify: bool) -> Zones; // NOTE: Consider accepting a vector of ZoneIDs
}
